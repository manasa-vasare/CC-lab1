...
_Proxmox VE (Type-1) vs VMware Workstation (Type-2)_

This lab manual guides the learner through creating identically configured virtual machines on a Type-1 hypervisor (Proxmox VE) and a Type-2 hypervisor (VMware Workstation), and then measuring and comparing their CPU performance using Sysbench.
